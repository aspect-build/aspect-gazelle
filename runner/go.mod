...
require (
	...
	github.com/bazel-contrib/rules_jvm v0.33.0 // NOTE: keep in sync with MODULE.bazel
	github.com/bazel-contrib/rules_python/gazelle v0.0.0-20260223163720-bac549496f67
